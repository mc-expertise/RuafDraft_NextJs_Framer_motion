  ...
  switch (id) {
    case 1:
      return {
        ...
        transition: { duration: 0.8, ease: [0.76, 0, 0.24, 1], delay: 2.4 },
      };
    case 2:
      return {
        top: 'calc(50% - 300px)',
        ...
        transition: { duration: 0.8, ease: [0.76, 0, 0.24, 1], delay: 2.45 },
      };
    case 3:
      return {
        top: '25%',
    ...
    case 4:
      return {
        ...
        transition: { duration: 0.8, ease: [0.76, 0, 0.24, 1], delay: 2.55 },
      };
    case 5:
      return {
        bottom: '5%',
        ...
        transition: { duration: 0.8, ease: [0.76, 0, 0.24, 1], delay: 2.6 },
      };
    case 6:
      return {
        bottom: '5%',
        ...
        transition: { duration: 0.8, ease: [0.76, 0, 0.24, 1], delay: 2.65 },
      };
    case 7:
      return {
        bottom: '20%',
